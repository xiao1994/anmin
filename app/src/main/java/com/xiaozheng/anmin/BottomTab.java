 ...
 *
 */
public class BottomTab extends FragmentActivity implements OnClickListener {
    ...
    private void clickTab2Layout() {
        if (iWantKnowFragment == null) {
            iWantKnowFragment = new Tab2Fragment();
        }
